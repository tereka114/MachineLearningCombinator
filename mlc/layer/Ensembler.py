	...
	def stacking(self,train_x=None,train_y=None,train_ids=None,test_ids=None,test_x=None,parameter=None,
		...
		for epoch in xrange(epochs):
			...
			if isTrain:
				...
				train_csv_name = '{}train_raw/{}.epoch{}.csv'.format(train_dir,pred_name,epoch)
				...
				for index,(train_index,valid_index) in enumerate(kfold):
					...
					prediction[valid_index] = clf.predict(valid_x_fold)
				...
				test_csv_name = '{}test_raw/{}.epoch{}.csv'.format(test_dir,pred_name,epoch)
...
class EmsambleRegression(object):
	...
	def predict(self,trains,tests,train_y):
